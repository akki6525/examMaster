...
export default function TestInterface() {
    ...
    const [questionTimeSec, setQuestionTimeSec] = useState(0);
            ...
            <header className="h-auto min-h-[4rem] border-b bg-card flex items-center justify-between px-3 md:px-4 py-2 flex-shrink-0 relative gap-2 flex-wrap">
                ...
                <div className="flex items-center gap-2 md:gap-4 flex-shrink-0 flex-wrap">
                    ...
                    <button
                        ...
                        className="hidden md:flex items-center gap-1.5 px-3 py-2 bg-muted/60 hover:bg-muted rounded-xl text-xs font-bold transition-colors border border-border"
                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="flex items-start justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="px-2.5 py-1 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20 text-xs font-mono font-bold flex items-center gap-1">
                                    <Clock className="w-3 h-3 animate-pulse" />
                                    {questionTimeSec}s on Q
                                </span>
                            </div>
                            <button
